...
# execuitng the instruction from the "chinook" database
...
# instead of connecting to the database direclty, we will ask for a session
...
szymon_stepien = Programmer(
    first_name="Szymon",
    last_name="Stepien",
    gender="M",
    nationality="Polish",
    famous_for="Creativity"
)
...
# deleting a single record - commnent
